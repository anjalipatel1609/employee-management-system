@include('header')
<h1 class="mt-4">Approved Tasks</h1>
                    ...
                    @if (isset($completedTask))
                        @if (count($completedTask) > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value = "{{ $eachCompletedTask->task_approved_remark }}" class="form-control" readonly>
                                </td>

                                <td>
                                    <a onclick = "return confirm('Are you sure to mark this task as not approved !')" href = "{{ route('not_approving_task', $eachCompletedTask->id) }}" style = "white-space : nowrap;" class="btn btn-primary">Not approved</a> 
                                </td>
