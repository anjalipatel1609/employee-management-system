@include('header')
<h1 class="mt-4">Allocated Task</h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="{{ url(route('home')) }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Allocated Task</li>
</ol>
...
<script>
    function markAsComplete(TaskID, ClientTaskID)
    {
        if(confirm('Are you sure to mark this task as completed !'))
        {
            window.location.href = "/mark_task_as_completed/" + TaskID + "/" + ClientTaskID;
        }
    }
</script>
@include('footer')
