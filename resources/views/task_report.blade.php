...
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Task Tracker</li>
</ol>
...
<style>
    ...
    <table class="table table-hover table-bordered results" id="myTable">
        <thead>
        <tr>
            <th scope="col" index="0">Employee<i class="fas fa-filter ml-2"></i>
                <div class="filter"></div>
            </th>
            <th scope="col" index="1">Client<i class="fas fa-filter"></i>
                <div class="filter"></div>
            </th>
            <th scope="col" index="2">Task<i class="fas fa-filter"></i>
                <div class="filter"></div>
            </th>
            <th scope="col" index="3">Allocate Date<i class="fas fa-filter"></i>
                <div class="filter"></div>
            </th>
            <th scope="col" index="4">Deadline<i class="fas fa-filter"></i>
                <div class="filter"></div>
            </th>
            <th scope="col" index="5">Status<i class="fas fa-filter"></i>
                <div class="filter"></div>
            </th>
        </tr>
        </thead>
        ...
        @if(count($allTasks) > 0)
            @foreach($allTasks as $eachTask)
                <tr>
                    <td>{{ $eachTask->employee->id }} &nbsp;&nbsp;|&nbsp;&nbsp; {{ $eachTask->employee->employee_name }}</td>
                    ...
                    <td>{{ \Carbon\Carbon::parse($eachTask->deadLine)->format('d/m/y h:i:s A') }}</td>
        ...
        @else
            <tr>
                <td colspan="6" style = "text-align: center;">No any data available yet !</td>
            </tr>
        @endif
